...
var SnapshotSchema = new Schema({
	...
	blob  		: Buffer,										// Content of the version
	idLastOp   	: {type : Schema.ObjectId, ref : 'Operation'},	// Foreign key of the last applied operation
	timestamp	: {type : Date, default : Date.now}				// Date
})

SnapshotSchema.virtual('preOpCondition').get(function () {
